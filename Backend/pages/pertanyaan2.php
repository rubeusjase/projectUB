...
<!-- End of Topbar -->
    ...
    <!-- Tambah Pertanyaan 2 -->
    <div class="container">
        <h4 class="mt-4 mb-4 text-center bg-cyan text-white p-2">Pertanyaan 2</h4>
        <form  method="post" action="<?php echo $_SERVER['PHP_SELF'] . '?page=pertanyaan2'; ?>">
            <div class="form-row">
                            ...
                            <div class="modal-dialog modal-md">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="<?php echo $_SERVER["PHP_SELF"]."?page=pertanyaan2" ?>" method="POST" enctype="multipart/form-data">
...
<?php
    ...
    $pertanyaan2 = new AuthService();  //instance class AuthService
    ...
    if(isset($_POST['aksi'])) {
        ...
        switch($aksi) {
            case 'new': //menambahkan data pertanyaan
                ...
                $hsl=$pertanyaan2->SavePertanyaan2($dtpertanyaan2, $aksi);
            ...
            case 'delete': //hapus data pertanyaan
                $id = $_POST['id'];
                $hsl=$pertanyaan2->deletePertanyaan2($id,'delete');
                if($hsl){
                    header("Refresh:0");
                }
                break;
