...
<!-- End of Topbar -->
    ...
    <!-- Tambah Pertanyaan 3 -->
    <div class="container">
        <h4 class="mt-4 mb-4 text-center bg-cyan text-white p-2">Pertanyaan 3</h4>
        <form  method="post" action="<?php echo $_SERVER['PHP_SELF'] . '?page=pertanyaan3'; ?>">
            <div class="form-row">
                            ...
                            <div class="modal-dialog modal-md">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="<?php echo $_SERVER["PHP_SELF"]."?page=pertanyaan3" ?>" method="POST" enctype="multipart/form-data">
...
<?php
    ...
    $pertanyaan3 = new AuthService();  //instance class AuthService
    ...
    if(isset($_POST['aksi'])) {
        ...
        switch($aksi) {
            case 'new': //menambahkan data pertanyaan
                ...
                $hsl=$pertanyaan3->SavePertanyaan3($dtpertanyaan3, $aksi);
            ...
            case 'delete': //hapus data pertanyaan
                $id = $_POST['id'];
                $hsl=$pertanyaan3->deletePertanyaan3($id,'delete');
                if($hsl){
                    header("Refresh:0");
                }
                break;
