...
<div class="container">
        <h4 class="mt-4 mb-4 text-center bg-cyan text-white p-2">Artikel 3</h4>

        <!-- Form untuk menambahkan artikel -->
        <form action="<?php echo $_SERVER['PHP_SELF'] . '?page=artikel3'; ?>" method="POST" enctype="multipart/form-data">
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="judul">Judul Artikel3:</label>
    ...
    if(isset($_POST['aksi'])) 
    {
        ...
        switch($aksi) {
            case 'new': //menambahkan data artikel
                ...
                $hsl=$auth->Saveartikel3($dtartikel3, $foto, $aksi);
            ...
            case 'delete': //menghapus data artikel
                $id = $_POST['id'];
                $hsl=$auth->deleteartikel3($id,'delete');
                if($hsl){
                    header("Refresh:0");
                }
                break;
