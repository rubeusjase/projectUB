...
<div class="container">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF'] . '?page=blog'; ?>" method="POST" enctype="multipart/form-data">
            <div class="form-row">
    ...
    if(isset($_POST['aksi'])) 
    {
        ...
        switch($aksi) {
            case 'new': //menambahkan data artikel
                ...
                $hsl=$auth->SaveBlog($dtblog, $foto, $aksi);
